/* first try to build a small indicator app to fit into the unity panel. 
   the app should be linked to the gnus email reader. 

   compile with : 
   gcc test_00.c -o test_00 `pkg-config --cflags --libs gtk+-2.0` `pkg-config --cflags --libs appindicator-0.1` */
